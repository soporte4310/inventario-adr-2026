...
class ActivoForm(forms.ModelForm):
    class Meta:
        model = Activo
        # No incluimos is_deleted, created_at, updated_at
        fields = [
            'catalogo', 'estado', 
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # Hacemos que todos los campos no obligatorios en BD tengan un placeholder amigable
